                ...
                <div class="x_content">
                    ...
                    <form onsubmit="return validateForm()" name="myform"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" type="text" name="festival_name" value="{{ old('festival_name') }}" >
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label class="radio-inline"><input  type="radio" name="festival_type" value="national">দেশী</label>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="festival_place" type="text" value="{{ old('festival_place') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="applicant_name"  type="text" value="{{ old('applicant_name') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input   class="form-control col-md-7 col-xs-12" name="applicant_email" type="email" value="{{ old('applicant_email') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="reg_no" type="text" value="{{ old('reg_no') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  type="file" name="reg_no_attach" value="{{ old('reg_no_attach') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="tin_no" type="text" value="{{ old('tin_no') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  type="file" name="tin_no_attach" value="{{ old('tin_no_attach') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  type="text" name="chaalan_no" value="{{ old('chaalan_no') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  type="text" name="bank_name" class="form-control col-md-7 col-xs-12" value="{{ old('bank_name') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input  type="text" name="branch_name" class="form-control col-md-7 col-xs-12" value="{{ old('branch_name') }}">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <label><input  type="radio" name="fee_type" value="national_fee">স্থানীয় মেলা আয়োজনের ফি ৫০০০/- (পাঁচ হাজার) টাকা</label>
